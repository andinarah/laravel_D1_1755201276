...
@section('content')    
    ...
    <div class="form-group row">      
        ...
        <div class="col-sm-3">        
            <input type="text" name="kode_prodi" class="form-control" id="kode_prodi" placeholder="Nomor Induk Prodi">        
    ...
    <div class="form-group row">      
        ...
        <div class="col-sm-5">        
            <input type="text" name="nama_prodi" class="form-control" id="nama_prodi" placeholder="Masukan nama dengan benar">        
